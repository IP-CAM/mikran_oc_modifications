            ...
            if (isset($data['route'])) {
                if ($data['route'] == 'product/product' && $key == 'product_id') {
                    ...
                    if(isset($data['meta_title'])) {
                        if(strcmp($data['meta_title'],$product_meta['meta_title']) != 0 ) {

                            $redirect_url = $url_info['scheme'] . '://' . $url_info['host'] . (isset($url_info['port']) ? ':' . $url_info['port'] : '') . "/".$lang_code."/id".$data['product_id'].'/'.$product_meta['meta_title'];
                    ...
                    return $url_info['scheme'] . '://' . $url_info['host'] . (isset($url_info['port']) ? ':' . $url_info['port'] : '') . "/".$lang_code."/id".$data['product_id'].'/'.$product_meta['meta_title'];
                }
            }
        }
            
        #return "https://mikran.com.pl/pl/id1234/this_is_my_product";                            
